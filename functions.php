...
load_theme_textdomain( 'gatineau', TEMPLATEPATH . '/languages' );
...
if ( function_exists( 'add_theme_support' ) ) { 
  ...
  set_post_thumbnail_size( 468, 300, true );
...
function replace_jquery() {
	if (!is_admin()) {
		...
		wp_register_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js',array(),'1.5.2',true);
